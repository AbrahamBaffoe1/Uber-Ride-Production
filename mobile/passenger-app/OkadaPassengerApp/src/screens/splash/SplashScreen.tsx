...
const COLORS = {
  ...
  PRIMARY_LIGHT: '#FFA348',  // Light Orange
  PRIMARY_DARK: '#E05D00',   // Dark Orange
  
  SECONDARY: '#3B82F6',      // Blue
  SECONDARY_LIGHT: '#7EB3FF',// Light Blue
  
  ACCENT: '#8B5CF6',         // Purple
  ACCENT_LIGHT: '#B794F6',   // Light Purple
  ...
  GRADIENT_END: '#FFF8F0',   // Very Light Orange
...
const PassengerIllustration = () => (
  <Svg width={180} height={140} viewBox="0 0 180 140">
    ...
    {/* Passenger */}
    <Circle cx="90" cy="25" r="10" fill="#333333" />
    <Path
      d="M90,35 L90,50"
      stroke="#333333"
      strokeWidth="3"
    ...
    />
    <Path
      d="M90,40 L80,50 M90,40 L100,50"
      stroke="#333333"
      strokeWidth="2"
      strokeLinecap="round"
    />
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.contentContainer}>
          ...
          >
            <Text style={styles.appName}>Okada Passenger</Text>
            <View style={styles.taglineContainer}>
              <Text style={styles.tagline}>Ride. Earn. Grow.</Text>
            </View>
            ...
            <View style={styles.featuresContainer}>
              <View style={styles.featureRow}>
                ...
                <Text style={styles.featureText}>Fast transportation</Text>
              </View>
